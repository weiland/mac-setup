...
###############################################################################
# Trackpad, mouse, touchbar, keyboard, Bluetooth accessories, and input       #
###############################################################################
...
# Don't show a thumbnail beforehand
...
echo "Done. Note that some of these changes require a reboot to take effect."